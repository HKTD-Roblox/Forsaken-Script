    ...
    if blockTPEnabled and Humanoid and tick() - lastBlockTpTime >= 5 then
        for _, track in ipairs(Humanoid:GetPlayingAnimationTracks()) do
            ...
            if animId == "72722244508749" or animId == "96959123077498" then
                local myRoot = lp.Character and lp.Character:FindFirstChild("HumanoidRootPart")
                if myRoot then
                    local killers = {"c00lkidd", "JohnDoe", "1x1x1x1", "Noli", "Slasher", "Azure", "Guest666", "Nosferatu"}
        ...
        pcall(function()
            ...
            if not fakeGui then
                local success, result = pcall(function()
                    return loadstring(game:HttpGet("https://raw.githubusercontent.com/HKTD-Roblox/Forsaken-Script/refs/heads/main/Fake-Block.lua"))()
                end)
                if not success then
...
CreditsTab:CreateParagraph({
    Title = "Credits",
    Content = "Script By HKTD, TikTok: https://www.tiktok.com/@hktd_roblox"
})
